...
export class CreateContractsDto {
  @dtoDecorators({
    swaggerOptions: {
      ...
      descriptionOpt: 'Titulo del contrato',
    },
    baseOptions: {
  ...
  @dtoDecorators({
    swaggerOptions: {
      example: 1,
      descriptionOpt: 'Id de la prueba',
    },
    baseOptions: {
      message: dtoValidatorMessage.requiredField(
  ...
  @dtoDecorators({
    swaggerOptions: {
      example: '2024-01-01',
      descriptionOpt: 'Fecha de inicio del contrato',
    },
    baseOptions: {
  ...
  @dtoDecorators({
    swaggerOptions: {
      example: '2024-01-01',
      descriptionOpt: 'Fecha de termino del contrato',
    },
    baseOptions: {
